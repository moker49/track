...
class TrackAppTest(unittest.TestCase):
    ...
    def test_cast_hydration_follows_tmdb_metadata_refresh_without_detail_request(self):
        ...
        self.assertLess(detail.data.index(b'data-cast-disclosure'), detail.data.index(b'detail-docked-toolbar'))
    ...
    def test_episode_watch_bar_has_no_queue_action(self):
        ...
        self.assertLess(
            ...
            episode_detail.data.index(b'detail-docked-toolbar'),
        )
    ...
    def test_show_details_are_a_fragment(self):
        ...
        self.assertLess(with_cast.data.index(b'data-cast-disclosure'), with_cast.data.index(b'detail-docked-toolbar'))
