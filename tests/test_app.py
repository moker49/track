...
class TrackAppTest(unittest.TestCase):
    ...
    def test_single_page_shell_contains_primary_views(self):
        ...
        self.assertIn("@keyframes profile-circular-reveal", css)
        ...
        self.assertIn("function openProfileFromTrigger(trigger)", javascript)
        self.assertIn('document.startViewTransition(revealProfile)', javascript)
