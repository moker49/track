...
class TrackAppTest(unittest.TestCase):
    ...
    def test_tv_filter_and_sort_dropdowns_are_in_the_scroll_content(self):
        home = self.client.get("/")
        ...
        self.assertIn(".tv-control-bar {", css)
        self.assertIn("position: sticky;", css)
        self.assertIn("top: calc(80px + env(safe-area-inset-top));", css)
        self.assertIn(".tv-control-bar.is-scroll-hidden {", css)
        self.assertIn("transform: translateY(calc(-100% - 12px));", css)
