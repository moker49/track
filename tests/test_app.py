...
class TrackAppTest(unittest.TestCase):
    ...
    def test_single_page_shell_contains_primary_views(self):
        ...
        self.assertIn(".detail-toolbar-button {", css)
    ...
    def test_cast_hydration_follows_tmdb_metadata_refresh_without_detail_request(self):
        ...
        self.assertIn(b'<details class="detail-section-disclosure" data-cast-disclosure>', detail.data)
        self.assertIn(b'Cast <span>\xc2\xb7 20</span>', detail.data)
        self.assertEqual(detail.data.count(b'class="cast-avatar'), 4)
        self.assertLess(detail.data.index(b'data-cast-disclosure'), detail.data.index(b'detail-bottom-actions'))
    ...
    def test_catalog_movie_preview_renders_cast_in_initial_fragment(self):
        ...
        self.assertIn(b'<div class="detail-bottom-actions"', detail.data)
        self.assertNotIn(b'<div class="detail-toolbar"', detail.data)
        self.assertIn(b'class="detail-fab" type="button" data-add-movie-action', detail.data)
    ...
    def test_tracked_movie_actions_use_toolbar_and_watch_fab(self):
        connection = sqlite3.connect(self.database)
        ...
        connection.commit()
        connection.close()
        detail = self.client.get(f"/api/movies/{movie_id}")
        self.assertEqual(detail.status_code, 200)
        self.assertIn(b'data-movie-action="remove"', detail.data)
        self.assertIn(b'<div class="detail-toolbar" style="--toolbar-items: 3">', detail.data)
        ...
        self.assertIn(b'class="detail-fab" type="button" data-movie-detail-watch', detail.data)
    ...
    def test_episode_watch_bar_has_no_queue_action(self):
        ...
        self.assertLess(
            ...
            episode_detail.data.index(b'detail-bottom-actions'),
        )
        self.assertEqual(episode_detail.data.count(b'data-episode-detail-watch'), 1)
        ...
        self.assertIn(b'class="detail-fab" type="button" data-episode-detail-watch', episode_detail.data)
    ...
    def test_show_detail_displays_total_watch_progress_and_overwatch_count(self):
        ...
        self.assertIn(b'aria-valuenow="138"', detail.data)
    ...
    def test_tv_controls_share_a_bottom_inline_bar(self):
        ...
        self.assertIn("const [showHtml, seasonsHtml] = await Promise.all", javascript)
        self.assertIn(
    ...
    def test_show_details_are_a_fragment(self):
        ...
        self.assertIn(b'class="detail-fab" type="button" data-reaction-toggle="queue"', detail.data)
        ...
        self.assertIn(b'<details class="detail-section-disclosure" data-cast-disclosure>', with_cast.data)
        self.assertIn(b'Cast <span>\xc2\xb7 1</span>', with_cast.data)
        self.assertEqual(with_cast.data.count(b'class="detail-region-divider"'), 3)
        self.assertLess(with_cast.data.index(b'data-cast-disclosure'), with_cast.data.index(b'detail-bottom-actions'))
        ...
        self.assertIn(b'data-show-action="remove"', archived_detail.data)
        ...
        self.assertLess(remove_position, refresh_position)
        self.assertLess(refresh_position, move_position)
        self.assertIn(b'aria-label="Resume Archived Test Show"', archived_detail.data)
    ...
    def test_tv_search_preview_stays_untracked_until_added(self):
        ...
        self.assertIn(b'<div class="detail-toolbar detail-toolbar--labeled">', detail.data)
        self.assertIn(b'<span>Archive</span>', detail.data)
        self.assertIn(b'class="detail-fab" type="button" data-track-show-state="ACTIVE"', detail.data)
        self.assertIn(b'data-show-tracked="false"', detail.data)
        self.assertIn(b'<details class="detail-section-disclosure" data-activity-log>', detail.data)
        self.assertIn(b'<details class="detail-section-disclosure" data-seasons-disclosure>', detail.data)
        self.assertLess(detail.data.index(b'data-season-list'), detail.data.index(b'data-track-show-state="ACTIVE"'))
        ...
        self.assertIn(b'data-adjacent-episode="previous"', episode_detail.data)
        self.assertIn(b'data-adjacent-episode="next"', episode_detail.data)
        self.assertNotIn(b'class="detail-fab"', episode_detail.data)
        ...
        self.assertIn(b'class="detail-fab" type="button" data-reaction-toggle="queue"', tracked_detail.data)
