...
class TrackAppTest(unittest.TestCase):
    ...
    def test_initial_library_order_matches_natural_default_sort(self):
        ...
        self.assertIn('window.history.scrollRestoration = "manual"', javascript)
    ...
    def test_tv_controls_share_a_bottom_inline_bar(self):
        ...
        self.assertIn("let tvScrollControlsReady = false;", javascript)
        self.assertIn("if (!tvScrollControlsReady)", javascript)
        ...
        self.assertIn("html.menu-open,", css)
        self.assertIn("body.menu-open {", css)
