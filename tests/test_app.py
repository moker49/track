...
class TrackAppTest(unittest.TestCase):
    ...
    def test_single_page_shell_contains_primary_views(self):
        ...
        self.assertEqual(home.data.count(b"data-clear-search"), 4)
        self.assertEqual(home.data.count(b">close</span>"), 5)
    ...
    def test_schedule_is_the_default_view_with_catch_up_and_upcoming(self):
        ...
        self.assertIn(b'data-schedule-search="watching test show episode 6"', home.data)
        ...
        self.assertIn('searchInput.placeholder = `Search ${searchLabel}`', javascript)
