...
class TrackAppTest(unittest.TestCase):
    ...
    def test_single_page_shell_contains_primary_views(self):
        ...
        self.assertNotIn("profileFloatingChrome", javascript)
        self.assertIn("function keepProfileChromeAtViewportEdge()", javascript)
        self.assertIn("function spawnProfileChromeHandoff(chrome)", javascript)
