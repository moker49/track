...
CREATE TABLE IF NOT EXISTS movie_metadata_refresh_failures (
...
CREATE INDEX IF NOT EXISTS idx_movie_metadata_refresh_failures_retry_after
    ON movie_metadata_refresh_failures(retry_after);
